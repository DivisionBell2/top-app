...
import { useEffect, useState, KeyboardEvent, KeyboardEventHandler, forwardRef, ForwardedRef, useRef } from "react";
import { ReactSVG as StarIcon } from 'react-svg';
        ...
        const updatedArray = ratingArray.map((r: JSX.Element, i: number) => {
            return (
                <span className={cn(styles.star, {
                    ...
                    onKeyDown={(e: KeyboardEvent) => handleKey}
